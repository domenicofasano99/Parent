...
public class AccountHelper {
    ...
    private void sendAccountConfirmationEmail(Account account) {
        ...
        emailMessage.text = "Click on the link to verify your BOK account: http://bok.faraone.ovh:8082/verificationToken?token=" + confirmationToken.getConfirmationToken();
